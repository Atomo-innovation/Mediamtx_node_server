...
def crop_b64(frame_bgr: np.ndarray, box: np.ndarray, pad: float = 0.22) -> str:
    """Crop face region (with padding), HD resize, encode as JPEG base64."""
