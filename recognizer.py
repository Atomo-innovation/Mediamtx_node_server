...
# Prefer TIM-VX NPU for OpenCV DNN (Khadas / Amlogic boards).
...
class NPUFaceRecognizer:
    ...
    def _load_cv(self, path: str):
        try:
            ...
            # Warm-up: compile graph on NPU and pin weights in device memory.
            ...
            for _ in range(3):
                ...
                net.forward()
            self._net_cv = net
            print("[Recognizer] TIM-VX NPU backend active (MobileFaceNet)", flush=True)
